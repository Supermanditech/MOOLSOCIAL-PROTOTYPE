(function () {
  ...
  window.MoolWorkspaceActivationRegistry = {
    ...
    profiles: {
      ...
      bike_captain: setup("Set up my bike", ["Vehicle and service zone", "Go-online availability", "Trips and payout account"]),
      auto_captain: setup("Set up my auto", ["Vehicle and service zone", "Go-online availability", "Trips and payout account"]),
      cab_captain: setup("Set up my car", ["Vehicle and service zone", "Ride packages and availability", "Trips and payout account"]),
